...
X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=.2,random_state=410)

classifier = DecisionTreeClassifier(max_depth=20, min_samples_split=6, mode='entropy')
